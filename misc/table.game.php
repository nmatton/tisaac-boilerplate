...
class GameState
{
     ...
     * Update notification is sent to all players whose state changed.
     * 
     * @param array $players The array of player id that should be made active. 
     * @param string|mixed $next_state The next state to transition to if "players" is empty. If "players" is not empty the value of "next_state" will be ignored (you can put whatever you want).
     * @param bool $bExclusive If "exclusive" parameter is not set or false it doesn't deactivate other previously active players. 
     * If its set to true, the players who will be multiactive at the end are only these in "$players" array.
     * 
