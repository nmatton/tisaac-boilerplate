          ...
          if (((nt = B(l)), (it = B(l, t.draggable)), 'function' == typeof c)) {
            ...
            (c =
              ...
              c.split(',').some(function (t) {
                if ((t = N(s, t.trim(), o, !1)))
                  return (
                    U({ sortable: n, rootEl: t, name: 'filter', targetEl: l, fromEl: o, toEl: o }), z('filter', n, { evt: e }), !0
                  );
              }))
          )
    ...
    _appendGhost: function () {
      if (!Z) {
        ...
        I((Z = q.cloneNode(!0)), n.ghostClass, !1),
          ...
          (Bt.ghost = Z),
          t.appendChild(Z),
          P(Z, 'transform-origin', (ht / parseInt(Z.style.width)) * 100 + '% ' + (ft / parseInt(Z.style.height)) * 100 + '%');
      }
    },
        ...
        Bt.eventCanceled
          ...
          : (z('setupClone', this),
            ...
            (n.cloneId = Lt(function () {
              z('clone', n),
                Bt.eventCanceled ||
                  (n.options.removeCloneOnHide || $.insertBefore(tt, q), n._hideClone(), U({ sortable: n, name: 'clone' }));
            })),
            e || I(q, i.dragClass, !0),
            e
        ...
        Bt.eventCanceled ||
          ...
          t &&
            ...
            q &&
              ...
              U({ sortable: this, name: 'unchoose', toEl: V, newIndex: null, newDraggableIndex: null, originalEvent: t }),
              $ !== V
                ? (0 <= ot &&
            ...
            (0 == T && 0 == p) ||
              ...
              (Zt[d].pid = setInterval(
                function () {
                  ...
                  ('function' == typeof i && 'continue' !== i.call(Bt.dragged.parentNode[j], e, t, n, qt, Zt[this.layer].el)) ||
          ...
          (t.prototype = {
            ...
            dragOverValid: function (t) {
              ...
              i.options.swap &&
                ...
                n &&
                  n !== t &&
                  ((t = te), (te = !1 !== o(n) ? (I(n, i.swapClass, !0), n) : null), t && t !== te && I(t, i.swapClass, !1)),
                r(),
                e(!0),
                a());
            },
                    ...
                    de ||
                      (h.animation &&
                        ...
                        ce.forEach(function (t) {
                          var e;
                          (t.thisAnimationDuration = null),
                            t !== ae && ((e = he ? k(t) : c), (t.fromRect = e), s.addAnimationState({ target: t, rect: e }));
                        })),
                      ge(),
                      ce.forEach(function (t) {
              ...
              if (
                ...
                for (; ce.length; ) {
                  ...
                  I(e, this.options.selectedClass, !1),
                    ce.shift(),
                    W({ sortable: this.sortable, rootEl: this.sortable.el, name: 'deselect', targetEl: e, originalEvent: t });
                }
            },
